...
const BorderGlow = ({
  ...
  useEffect(() => {
    ...
    card.style.setProperty('--cursor-angle', `${a1}deg`);
    animateValue({ duration: 500, onUpdate: v => card.style.setProperty('--edge-proximity', v) });
    animateValue({ ease: easeInCubic, duration: 1500, end: 50, onUpdate: v => card.style.setProperty('--cursor-angle', `${(a2-a1)*(v/100)+a1}deg`) });
    animateValue({ ease: easeOutCubic, delay: 1500, duration: 2250, start: 50, end: 100, onUpdate: v => card.style.setProperty('--cursor-angle', `${(a2-a1)*(v/100)+a1}deg`) });
